...
void MassSystematics() {
    ...
    TF1 *f_SmearSysPosDiff = new TF1("f_SmearSysPosDiff", SmearSysPosDiff, 0.037, 0.178);
    TF1 *f_SmearSysNegDiff = new TF1("f_SmearSysNegDiff", SmearSysNegDiff, 0.037, 0.178);
    ...
    outSmearStat << " 1 $\\sigma$ upper function & " << pars[0] << " & " << pars[1] << " & " << pars[2] << " & " << pars[3] << " & " << pars[4] << " \\\\ \\hline " << endl;
    f_Pol4->SetLineColor(2);
    ...
    outSmearStat << " 1 $\\sigma$ lower function & " << pars[0] << " & " << pars[1] << " & " << pars[2] << " & " << pars[3] << " & " << pars[4] << " \\\\ \\hline " << endl;
    ...
    TF1 *f_SmearStatPosDiff = new TF1("f_SmearStatPosDiff", SmearStatPosDiff, 0.035, 0.18);
    ...
    TF1 *f_SmearStatNegDiff = new TF1("f_SmearStatPosDiff", SmearStatNegDiff, 0.035, 0.18);
